...
const journalDate=computed(()=>data.value?.date.replaceAll('-','.')||'')
    ...
    <template v-else-if="data">
      <div class="daily-grid">
        ...
        <aside class="today-aside">
          ...
          <RouterLink class="journal-glance" :to="{path:'/journal',query:{date:data.date}}" aria-label="打开今天的日记">
            <header class="journal-letterhead"><span>DAILY JOURNAL</span><time>{{journalDate}}</time></header>
            <blockquote>{{journalText}}</blockquote>
            <footer><span>PRIVATE ARCHIVE</span><i>阅读全文&nbsp; →</i></footer>
          </RouterLink>
        </aside>
      </div>
    </template>
